...
public class Main {
  ...
  public static void objectToJson() {
    ...
    movie.setActors(Arrays.asList("최민식", "유해진", "김고은", "이도현"));
    movie.setStars(9.5);
  ...
  public static void jsonToObject() {
    ...
    //----- JSON 문자열
    String json = "{\"title\":\"파묘\",\"director\":\"장지환\",\"actors\":[\"최민식\",\"유해진\",\"김고은\",\"이도현\"],\"stars\":9.5}";
  ...
  public static void mapToJson() {
    ...
    map.put("actors", Arrays.asList("최민식", "유해진", "김고은", "이도현"));
    map.put("stars", 9.5);
  ...
  public static void jsonToMap() {
    ...
    String json = "{\"actors\":[\"최민식\",\"유해진\",\"김고은\",\"이도현\"],\"director\":\"장지환\",\"stars\":9.5,\"title\":\"파묘\"}";
