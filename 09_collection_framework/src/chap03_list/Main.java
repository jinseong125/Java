 ...
 * 3. Iterable 인터페이스의 하위 인터페이스로 for-each 같은 반복문에서 활용할 수 있습니다.
 ...
 *    2) LinkedList : 연결 리스트. 서로 다른 공간을 참조로 연결해서 사용하는 리스트. 순회가 느리지만, 추가/삭제가 빠릅니다.
...
public class Main {
  ...
  //----- immutable : 저장된 요소의 개수를 변경할 수 있는 리스트
   ...
   */
   seasons.set(0, "aespa");  // 인덱스 0 요소 수정 (성공)
  ...
  public static void sort() {
    ...
    list2.add(new Data(20)); list2.add(new Data(10)); list2.add(new Data(30)); list2.add(new Data(40));
