package chap01_one_dimention;

import java.util.Arrays;

public class OneDimentionEx {
  ...
  public static void main(String[] args) {
    ...
    // 배열 생성
    blackPink = new String[4];       //----- new - 힙 영역에 string 저장이 가능한 연속된 4개 메모리 공간이 생성됩니다.
                                     //----- 그 중 첫 번째 공간의 참조값을 참조 변수 blackPink에 저장합니다.
                                     //----- 힙 영역에 생성된 4개 메모리 공간[4]은 늘이거나 줄일 수 없습니다.
