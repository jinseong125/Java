...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    //----- 정적 메소드 참조
    Function<String, Integer> f = Integer::parseInt;    // Function<String, Integer> f = n -> Integer.parseInt(n);
    System.out.println(f.apply("123") + 10);
    
    //----- 인스턴스 메소드 참조
    Consumer<String> c = System.out::println;   // Consumer<String> c = t -> System.out.println(t);
    c.accept("Java");
    ...
    //----- 생성자 참조
    Function<String, StringBuilder> builder = StringBuilder::new;   // Function<String, StringBuilder> builder = str -> new StringBuilder(str);
