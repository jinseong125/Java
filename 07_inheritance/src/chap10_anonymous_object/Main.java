 ...
 * 
 * 1. 인터페이스(또는 추상클래스)를 구현할 때(상속할 때) 구현 클래스(서브클래스)를 즉석에서 선언하고 객체로 생성하는 방법입니다.
 * 2. 대표적으로 이벤트 처리와 같이 한 번만 처리하는 작업에서 많이 활용됩니다.
 * 3. 문법
 *    인터페이스 타입의 참조변수 = new 인터페이스(매개변수, ...) {
 *    @Override // 필수
 *    void method() {...}
 *    }
 */
...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    // class Chihuahua 없이 chihuahua 객체 만들기
