 ...
 *    2) 칼럽(Column) 단위 조회 : 타입 기반의 메소드를 이용해 각 칼럼을 조회(getInt(), getString() 등)
...
public class Main {
  ...
  public static void singleRow() throws Exception {
    ...
    //----- 쿼리문
    String sql = "SELECT uid, nickname FROM tbl_user WHERE uid = ?";  // PK의 동등비교가 하나밖에 없음.(placeholder - ?)
  ...
  public static void join() throws Exception {
    ...
    //----- 다중 행 결과 저장하기 (tbl_user, tbl_board)
