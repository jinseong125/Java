 ...
 * 
 * 1. 바이트 기반 출력 스트림들의 최상위 클래스입니다. (직접 인스턴스를 생성할 수 없습니다.)
 ...
 *    4) PrintStream
 * 4. 주요 메소드
 *    1) write(int b) : 1바이트 출력합니다. (4바이트 중 하위 1바이트만 사용합니다.)
...
public class Main {
  ...
  public static void fileCreate() {
    ...
    OutputStream os = null;  // try, catch, finally 블록에서 모두 접근
    try {
  ...
  public static void bufferedOutputStream() {
     ...
     * 2. 출력 스트림의 기능에 내부 버퍼(대락 8KB)를 추가하여 출력 효율을 높인 클래스입니다.
